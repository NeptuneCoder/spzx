...
import com.atguigu.spzx.travel.mapper.UserInfoMapper;
...
// 获取数据
    ...
    @Override
    public UserInfoVo login(UserLoginCodeDto userLogincodeDto) {
        //校验参数
        ...
        if (null == userInfo) {
            ...
            //todo
            userInfo = new UserInfo();
            userInfo.setPhone(userLogincodeDto.getPhone());
            userInfo.setUsername(userLogincodeDto.getPhone().substring(0, 3) + "****" + userLogincodeDto.getPhone().substring(7));
